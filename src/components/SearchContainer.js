...
const SearchContainer = () => {
  ...
  return (
    <div className=" pt-[14.5px] sm:py-[6.5px] w-1/5 absolute right-20 mr-5 mt-0.75">
      <div className="flex items-center gap-2 sm:justify-center group/item  ">
        <form
          className="flex border border-black rounded-full focus-within:shadow-lg focus-within:absolute -right-[19%] bottom-[8.5px] bg-white focus-within:md:right-[0px]"
          ref={searchFormRef}
        >
          <SearchInput
        ...
        {/* <div className="hidden sm:block text-xl cursor-pointer hover:bg-green-200 rounded-full p-3 relative  group sm:group-focus-within/item:hidden ">
          <IoMdMic />
